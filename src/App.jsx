    ...
    <div className="app">
      <header className="header">
        <div className="header-inner">
          <div className="logo"><div className="logo-s">S</div><span>SAMELIS</span></div>
      ...
      <div className="trust-bar">
        ...
        <div className="trust-item">🛡️ 100% Genuine • SAMELIS Verified</div>
      ...
      <footer className="footer">
        <div className="footer-inner">
          <div><div className="logo" style={{ color: 'white', marginBottom: 10 }}><div className="logo-s">S</div><span>SAMELIS</span></div><div style={{ fontSize: 13, lineHeight: 1.6 }}>Premium footwear Nairobi. Genuine leather. Till {TILL} • Lipa na M-Pesa</div></div>
